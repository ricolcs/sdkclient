...
public class VesselVoyageHistory {
    ...
    public VesselVoyageHistory() {
    }

    public VesselVoyageHistory(Long shipid) {
        this.shipid = shipid;
    }

    public VesselVoyageHistory(String mmsi) {
        this.mmsi = mmsi;
    }

    public VesselVoyageHistory(Long shipid, String mmsi) {
        this.shipid = shipid;
        this.mmsi = mmsi;
    }
